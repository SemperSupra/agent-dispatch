// R3a bridge PID1: mount pinned Ubuntu userspace + preloaded scratch and run the real Agent Dispatch contract workload.
...
static void fail(u64 code){char out[96];usize at=0;at=append_lit(out,at,"FIRECRACKER_R3A_ERROR code=");at=append_dec(out,at,code);out[at++]='\n';sc3(1,1,(long)out,(long)at);reboot_guest();}
...
void _start(void){
    ...
    char out[96];usize at=0;at=append_lit(out,at,"FIRECRACKER_R3A_EXIT code=");at=append_dec(out,at,(u64)code);out[at++]='\n';sc3(1,1,(long)out,(long)at);
    reboot_guest();
}
