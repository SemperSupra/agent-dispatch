// R3b bridge PID1: immutable Ubuntu userspace + writable scratch containing one bounded broker client.
...
static void fail(u64 code){char out[96];usize at=0;at=append_lit(out,at,"FIRECRACKER_R3B_ERROR code=");at=append_dec(out,at,code);out[at++]='\n';sc3(1,1,(long)out,(long)at);reboot_guest();}
...
void _start(void){
    ...
    if(pid==0){
        char *argv[]={(char*)"/usr/bin/python3",(char*)"/tmp/r3b.py",0};
    ...
    char out[96];usize at=0;at=append_lit(out,at,"FIRECRACKER_R3B_EXIT code=");at=append_dec(out,at,(u64)code);out[at++]='\n';sc3(1,1,(long)out,(long)at);reboot_guest();
}
